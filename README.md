...
|[MA0184](https://github.com/meziantou/Meziantou.Analyzer/blob/main/docs/Rules/MA0184.md)|Usage|Do not use interpolated string without parameters as argument for interpolated string handler|ℹ️|✔️|✔️|

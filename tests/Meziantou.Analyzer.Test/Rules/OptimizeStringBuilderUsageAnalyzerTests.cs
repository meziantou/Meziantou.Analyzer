        ...
        await CreateProjectBuilder()
              ...
              .ShouldFixCodeWith("""
                  ...
                  class Test
                  {
                      void A()
                      {
                          new StringBuilder().Append('A').Append(1).Append(""BC"
                  """.AppendFormat(""{0:X2}"", 2).Append(""DEF"
    }
}")
              .ValidateAsync();
    }
        ...
        await CreateProjectBuilder()
              ...
              .ShouldFixCodeWith("""
                  ...
                  class Test
                  {
                      ...
                      {
                          new StringBuilder().Append('A').Append(1).Append(""BC"
                  """.AppendFormat(""{0:X2}"", 2).AppendLine(""DEF"
    }
}")
              .ValidateAsync();
    }
        ...
        await CreateProjectBuilder()
              ...
              .ShouldFixCodeWith("""
                  ...
                  class Test
                  {
                      ...
                      {
                          new StringBuilder().Append('A').Append(1).Append(""BC"
                  """.AppendFormat(""{0:X2}"", 2).Append('D').AppendLine();
    }
}")
              .ValidateAsync();
    }
        ...
        await CreateProjectBuilder()
              ...
              .ShouldFixCodeWith("""
                  ...
                  class Test
                  {
                      ...
                      {
                          new StringBuilder().Append('A').Append(1).Append(""BC"
                  """.AppendFormat(""{0:X2}"", 2).AppendLine();
    }
}")
              .ValidateAsync();
    }

...
public sealed class UseIFormatProviderAnalyzerTests
{
    ...
    [InlineData(""" new System.Text.StringBuilder().AppendFormat("{0}", new object[] { "X" }) """)]
    [InlineData(""" {|MA0011:new System.Text.StringBuilder().AppendFormat("{0}", new object[] { -1 })|} """)]
    [InlineData(""" {|MA0011:new System.Text.StringBuilder().AppendFormat("{0}", new object[1])|} """)]
    ...
    [InlineData(""" string.Format("", new object[] { "test", 'c' }) """)]
    [InlineData(""" {|MA0011:string.Format("", new object[] { "test", -1 })|} """)]
    [InlineData(""" {|MA0011:string.Format("", new object[1])|} """)]

...
|[MA0027](https://github.com/meziantou/Meziantou.Analyzer/blob/main/docs/Rules/MA0027.md)|Usage|Do not remove original exception|<span title='Warning'>⚠️</span>|✔️|✔️|
...
|[MA0040](https://github.com/meziantou/Meziantou.Analyzer/blob/main/docs/Rules/MA0040.md)|Usage|Flow the cancellation token|<span title='Info'>ℹ️</span>|✔️|❌|
...
|[MA0045](https://github.com/meziantou/Meziantou.Analyzer/blob/main/docs/Rules/MA0045.md)|Design|Do not use blocking call in a sync method (need to make containing method async)|<span title='Info'>ℹ️</span>|❌|❌|
...
|[MA0061](https://github.com/meziantou/Meziantou.Analyzer/blob/main/docs/Rules/MA0061.md)|Design|Method overrides should not change parameter defaults|<span title='Warning'>⚠️</span>|✔️|❌|
...
|[MA0065](https://github.com/meziantou/Meziantou.Analyzer/blob/main/docs/Rules/MA0065.md)|Performance|Default ValueType.Equals or HashCode is used for struct's equality|<span title='Warning'>⚠️</span>|✔️|❌|
...
|[MA0079](https://github.com/meziantou/Meziantou.Analyzer/blob/main/docs/Rules/MA0079.md)|Usage|Flow the cancellation token using .WithCancellation()|<span title='Info'>ℹ️</span>|✔️|❌|
...
|[MA0084](https://github.com/meziantou/Meziantou.Analyzer/blob/main/docs/Rules/MA0084.md)|Design|Local variable should not hide other symbols|<span title='Warning'>⚠️</span>|✔️|❌|

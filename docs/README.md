...
|[MA0040](https://github.com/meziantou/Meziantou.Analyzer/blob/main/docs/Rules/MA0040.md)|Usage|Pass along the cancellation token|<span title='Info'>ℹ️</span>|✔️|❌|
...
|[MA0061](https://github.com/meziantou/Meziantou.Analyzer/blob/main/docs/Rules/MA0061.md)|Design|Method overrides should not change default arguments|<span title='Warning'>⚠️</span>|✔️|❌|
...
|[MA0079](https://github.com/meziantou/Meziantou.Analyzer/blob/main/docs/Rules/MA0079.md)|Usage|Pass along the cancellation token using .WithCancellation()|<span title='Info'>ℹ️</span>|✔️|❌|
...
dotnet_diagnostic.MA0040.severity = suggestion # MA0040: Pass along the cancellation token
...
dotnet_diagnostic.MA0061.severity = warning    # MA0061: Method overrides should not change default arguments
...
dotnet_diagnostic.MA0079.severity = suggestion # MA0079: Pass along the cancellation token using .WithCancellation()
...
dotnet_diagnostic.MA0045.severity = none       # MA0045: Do not use blocking call in a sync method (need to make calling method async)

...
The rule applies to positional records and to C# 12 type declarations with primary constructors when the type body contains no members, comments, or directives, and when the type has no XML documentation comment.

...
The code fix copies the pattern and the options to the `[GeneratedRegex]` attribute. When they reference a local constant, which is not in scope in the attribute, it uses their constant value instead:

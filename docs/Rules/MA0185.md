...
- A parameter is maybe culture-sensitive, such as one typed as `object`, an interface, a type parameter, or a non-sealed class, as its runtime type may format differently. This rule requires proof that all parameters are culture-insensitive.

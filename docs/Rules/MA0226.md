...
The code fix adds the `sealed` modifier. It is not offered when other classes derive from the class, as they would no longer compile: make the class `abstract` instead.

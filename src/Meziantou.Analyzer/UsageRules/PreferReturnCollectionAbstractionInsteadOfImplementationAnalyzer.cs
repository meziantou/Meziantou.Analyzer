...
namespace Meziantou.Analyzer.UsageRules
{
    ...
    public class PreferReturnCollectionAbstractionInsteadOfImplementationAnalyzer : DiagnosticAnalyzer
    {
        ...
        private void AnalyzeDelegate(SyntaxNodeAnalysisContext obj)
        {
        }

        private void AnalyzeIndexer(SyntaxNodeAnalysisContext obj)
        {
        }

        private void AnalyzeProperty(SyntaxNodeAnalysisContext obj)
        {
        }

        private void AnalyzeMethod(SyntaxNodeAnalysisContext obj)
        {
        }
